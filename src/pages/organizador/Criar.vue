            ...
            <v-flex xs12 sm4 elevation-6>
                ...
                <v-card>
                    <v-card-text class="pt-4">
                        <div>
                            <form>
                                <v-text-field label="Nome" outline color="rgb(70, 180, 199)" v-model="nome" :rules="emailRules" required/>
                                <v-divider/>
                                ...
                                <!-- <v-checkbox v-model="checkbox" v-validate="'required'" value="1" label="Option" type="checkbox" required></v-checkbox> -->
